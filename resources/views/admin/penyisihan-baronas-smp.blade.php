...
@section('title', 'Penyisihan Baronas SMP Admin | Evolution 2023')
    ...
    <div class="container-fluid" style="margin-bottom: 20px; background-color: white">
        ...
        <div class="row">
            <div class="column" style="margin: auto;">
                <h6 class="heading text-muted mb-4">Jadwal Penyisihan Baronas SMP</h6>
            </div>
        </div>
        <div class="row">
            <div class="column" style="width: 30%; padding: 20px; margin:auto">
                <h6 class="heading text-muted mb-4" style="margin-top: 20px;">Room 1</h6>
                <form method="POST" enctype="multipart/form-data" action="{{ route('admin.penyisihanBaronasSmpRoom1') }}">
                    @csrf
            ...
            <div class="column" style="width: 30%; padding: 20px; background-color: white; margin:auto">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('admin.penyisihanBaronasSmpRoom2') }}">
                    @csrf
                    <div class="form-group">
                        <label class="form-control-label" for="input-name">Waktu Bertanding</label>
            ...
            <div class="column" style="width: 30%; padding: 20px; background-color: white; margin:auto">
                ...
                <form method="POST" enctype="multipart/form-data"
                    action="{{ route('admin.penyisihanBaronasSmpRoom3') }}">
                    @csrf
                    <div class="form-group">
                        <label class="form-control-label" for="input-name">Waktu Bertanding</label>
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            function fetch_data() {
                $.ajax({
                    url: "/admin/penyisihan/baronas/smp/fetch-data",
                    dataType: "json",
            ...
            function fetch_schedule1() {
                $.ajax({
                    url: "/admin/penyisihan/baronas/smp/fetch-schedule1",
                    dataType: "json",
            ...
            function fetch_schedule2() {
                $.ajax({
                    url: "/admin/penyisihan/baronas/smp/fetch-schedule2",
                    dataType: "json",
                    success: function(schedule) {
                        var waktu_tanding = '';
                        var waktu_tunggu = '';
            ...
            function fetch_schedule3() {
                $.ajax({
                    url: "/admin/penyisihan/baronas/smp/fetch-schedule3",
                    dataType: "json",
                    success: function(schedule) {
                        var waktu_tanding = '';
                        var waktu_tunggu = '';
            ...
            $(document).on('click', '#add', function() {
                ...
                if (nama_tim != '' && skor != '' && waktu != '' && jumlah_tanding != '') {
                    $.ajax({
                        url: "{{ route('admin.penyisihanBaronasSmpAddData') }}",
                        method: "POST",
                        data: {
                            nama_tim: nama_tim,
                            skor: skor,
            ...
            $(document).on('blur', '.column_name', function() {
                ...
                if (column_value != '') {
                    $.ajax({
                        url: "{{ route('admin.penyisihanBaronasSmpUpdateData') }}",
                        method: "POST",
                        data: {
            ...
            $(document).on('blur', '.column_schedule1', function() {
                ...
                if (column_schedule_value != '') {
                    $.ajax({
                        url: "{{ route('admin.penyisihanBaronasSmpUpdateSchedule1') }}",
                        method: "POST",
                        data: {
            ...
            $(document).on('blur', '.column_schedule2', function() {
                ...
                if (column_schedule_value != '') {
                    $.ajax({
                        url: "{{ route('admin.penyisihanBaronasSmpUpdateSchedule2') }}",
                        method: "POST",
                        data: {
                            column_schedule: column_schedule,
                            column_schedule_value: column_schedule_value,
            ...
            $(document).on('blur', '.column_schedule3', function() {
                ...
                if (column_schedule_value != '') {
                    $.ajax({
                        url: "{{ route('admin.penyisihanBaronasSmpUpdateSchedule3') }}",
                        method: "POST",
                        data: {
                            column_schedule: column_schedule,
                            column_schedule_value: column_schedule_value,
            ...
            $(document).on('click', '.delete', function() {
                ...
                if (confirm("Are you sure you want to delete this records?")) {
                    $.ajax({
                        url: "{{ route('admin.penyisihanBaronasSmpDeleteData') }}",
                        method: "POST",
                        data: {
                            id: id,
                            _token: _token
