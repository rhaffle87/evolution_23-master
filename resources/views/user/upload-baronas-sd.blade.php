...
@section('title', 'Upload Link Video Baronas SD | Evolution 2023')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                @if ($baronas['email'] != null && $baronas['kategori'] == 'SD' && $baronas['link_video'])
                                ...
                                @if ($baronas['pembayaran_status'] == 0 && $baronas['kategori'] == 'SD' && $baronas['email'] != null)
                                ...
                                @if ($baronas['email'] != null && $baronas['kategori'] != 'SD')
                                    <div class="alert alert-warning alert-block">
                                        Anda tidak mendaftar kategori SD. Silahkan pilih sesuai kategori lomba yang anda
                                        daftarkan.
                                    </div>
                                @endif
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" enctype="multipart/form-data"
                                                action="{{ route('user.uploadBaronasSd') }}">
                                                @csrf
