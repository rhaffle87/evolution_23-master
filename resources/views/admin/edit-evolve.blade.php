...
@section('title', 'Edit Evolve Admin | Evolution 2023')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h6 class="heading text-muted mb-4">Edit Akun Peserta Evolve</h6>
                                        <form method="POST" enctype="multipart/form-data"
                                            action="{{ route('admin.editEvolve') }}">
                                            @csrf
                                            <div class="form-group">
                                                ...
                                                <input name="email" type="text" id="nomor-hp" class="form-control"
                                                    ...
                                                    value="{{ $evolve->email }}" required disable>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-name">Nama Lengkap</label>
                                                <input name="nama" type="text" id="nama" class="form-control"
                                                    placeholder="Nama Tim" value="{{ $evolve->nama }}" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-phone">No Telp</label>
                                                <input name="nomor_telp" type="number" id="nomor_telp" class="form-control"
                                                    placeholder="Nomor Telp" maxlength="14"
                                                    value="{{ $evolve->nomor_telp }}" required>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input name="institusi" type="text" id="institusi" class="form-control"
                                                    placeholder="Institusi" value="{{ $evolve->institusi }}" required>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input name="domisili" type="text" id="domisili" class="form-control"
                                                    ...
                                                    value="{{ $evolve->domisili }}" required>
                                            </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button data-target="#daftarevolve" type="submit"
                                                                ...
                                                                style="color: white; background-color: #1a174d">Konfirmasi</button>
