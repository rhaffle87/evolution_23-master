...
@section('title', 'Upload File dan Link Video Baronas Umum | Evolution 2023')
                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a style="color: #172B4D">Upload File Porposal dan Link Video
                                        Baronas Kategori Umum</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                @if ($baronas['email'] != null && $baronas['kategori'] == 'UMUM' && $baronas['link_video'])
                                ...
                                @if ($baronas['pembayaran_status'] == 0 && $baronas['kategori'] == 'UMUM' && $baronas['email'] != null)
                                ...
                                @if ($baronas['email'] != null && $baronas['kategori'] != 'UMUM')
                                    <div class="alert alert-warning alert-block">
                                        Anda tidak mendaftar kategori umum. Silahkan pilih sesuai kategori lomba yang anda
                                        daftarkan.
                                    </div>
                                @endif
                                ...
                                @if (
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h6 class="heading text-muted mb-4">Seleksi Berkas Baronas</h6>
                                            <form method="POST" enctype="multipart/form-data"
                                                action="{{ route('user.uploadBaronasUmum') }}">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleFormControlFile1">Unggah File Full Paper (Format pdf,
                                                        ukuran file max. 2MB) </label>
                                                    <input name="file_full_paper" accept="application/pdf" type="file"
                                                        class="form-control-file" id="file-full-paper"
                                                        {{ $baronas['file_full_paper'] == '' ? '' : 'disabled' }} required>
                                                </div>
