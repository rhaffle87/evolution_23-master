                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a style="color: #172B4D">Pembayaran Baronas Paper</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                @if ($baronas['email'] != null && $baronas['bukti_bayar'] == null)
                                    <div class="alert alert-default" role="alert">
                                        ...
                                        a.n Canya Freya
                                        <br><br>
                                        <!-- NB: Bagi tim yang mendapat potongan pendaftaran 5 tim harap menghubungi CP di bawah
                                                                                                        <br><br> -->
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('user.bayarBaronasPaper') }}"
                                                enctype="multipart/form-data" method="POST" id="pilihan-pembayaran">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleFormControlFile1">Unggah Bukti Pembayaran (Format
                                                        jpg, jpeg, png)</label>
                                                    <input name="file_bukti" accept="image/*" type="file"
                                                        class="form-control-file" id="bukti-pendaftaran">
                                                    <small>Maksimal file adalah 1 MB</small>
                                                </div>
