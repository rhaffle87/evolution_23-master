...
@section('container')
    ...
    <div class="ex-basic-1 pt-6 pb-12">
        <div class="container px-4 sm:px-8 xl:px-32">
            ...
            <div class="flex">
                <button type="submit"
                    class="w-100 mx-auto text-white bg-orange-1-evol focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
