...
@section('container')
    ...
    <div class="header pb-6 d-flex align-items-center"
        style="min-height: 500px; background-image: url(/img/theme/hero.jpeg); background-size: cover; background-position: center top;">
        <!-- Mask -->
        ...
        <div class="container d-flex align-items-center">
            <div class="row">
                <div class="col-lg-12 col-md-10">
                    <h1 class="display-2 text-white mb-5" style="font-size: 50px; text-align: center">TELAH BERAKHIR SEMUA
                        SESI SEMIFINAL ELECTRA 2023</h1>
                </div>
            </div>
        </div>
    </div>
                                        ...
                                        <div class="alert alert-default" role="alert" style="text-align: center">
                                            ...
                                            <a href="/user/dashboard">
                                                <button type="submit" value="daftar"
                                                    class="btn btn-md col-5 col-lg-2 mt--3"
                                                    style="color: white; background-color: #707CAA">
                                                    Dashboard
                                                </button>
                                            </a>
