                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-12 col-md-4" style="width: 100%;">
                                    <div class="card" style="width: 100%;">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title" style="font-size: xx-large; text-align: center;">Nametag
                                                Baronas</h5>
                                            <a href="{{ url('/user/kartu-peserta-baronas/unduh') }}"
                                                class="btn text-lighter"
                                ...
                                <div class="col-12 col-md-4" style="width: 100%;">
                                    <div class="card" style="width: 100%;">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title" style="font-size: xx-large; text-align: center;">Nametag
                                                Robot Baronas</h5>
                                            <a href="{{ url('/user/kartu-peserta-baronas/unduh-nametag-robot') }}"
                                                class="btn text-lighter"
                                                style="display:flex; justify-content: center; align-items: center; background-color: #264579;">Unduh
                                                Nametag Robot</a>
                                        </div>
