...
@section('title', 'Upload Link Video Baronas SMA | Evolution 2023')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                @if ($baronas['email'] != null && $baronas['kategori'] == 'SMA' && $baronas['link_video'])
                                ...
                                @if ($baronas['pembayaran_status'] == 0 && $baronas['kategori'] == 'SMA' && $baronas['email'] != null)
                                ...
                                @if ($baronas['email'] != null && $baronas['kategori'] != 'SMA')
                                    <div class="alert alert-warning alert-block">
                                        Anda tidak mendaftar kategori SMA. Silahkan pilih sesuai kategori lomba yang anda
                                        daftarkan.
                                    </div>
                                @endif
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" enctype="multipart/form-data"
                                                action="{{ route('user.uploadBaronasSma') }}">
                                                @csrf
